---
title: "check coverage after adding weights"
author: "DongyueXie"
date: "2021-07-23"
...
summary_simu_study = function(out1){
  rmses = c()
  for(k in 1:K){
  ...
  print('coverage')
  print(colMeans(abs(z.err.hc3)<1.96))
  ...
  boxplot(out1$p_hat_se,col='grey80',ylab='se',ylim = range(apply(out1$p_hat_se,2,quantile,c(0,0.95))))
