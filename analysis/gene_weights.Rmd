...
#'@param b true beta
#'@param X reference mai
#'@param Y bulk data
#'@param Vg variance
#'@param w.mode "res", "res+ref_var", "ref_var", "res+bvb"
...
simu_func = function(design.mat,datax,b,b.res){
  
  n_bulk = ncol(datax$y)
  G = nrow(design.mat$X)
  cat('---no weight---',"\n")

  b.est0 = wols(design.mat$X,datax$y,W=rep(1,G),w.mode = 'ref_var',b=b.res)
  print(paste("rmse",round(rmse(rep(1,n_bulk)%*%t(b/sum(b)),(b.est0)),3)))
  print(round(b.est0,2))

  b.est = wols(design.mat$X,datax$y,W=rep(1,G),Vg = design.mat$Vg,b=b.res,w.mode='ref_var',adj.v = TRUE)
  ...
  for(i in 1:dim(design.mat$X_array)[3]){
    Sigma_sample = cbind(Sigma_sample,(design.mat$X_array[,,i] - design.mat$X)%*%b.res)
  }
  w = diag.cov(t(Sigma_sample))


  b.est.ref0 = wols(design.mat$X,datax$y,W=w,w.mode = 'ref_var',b=b.res)
  print(paste("rmse",round(rmse(rep(1,n_bulk)%*%t(b/sum(b)),(b.est.ref0)),3)))
  print(round(b.est.ref0,2))

  b.est.ref = wols(design.mat$X,datax$y,W=w,Vg = design.mat$Vg,b=b.res,w.mode='ref_var',adj.v = TRUE)
  ...
  b.est.ref0 = wols(design.mat$X,datax$y,b=b.res,w.mode='res')
  print(paste("rmse",round(rmse(rep(1,n_bulk)%*%t(b/sum(b)),(b.est.ref0)),3)))
  print(round(b.est.ref0,2))

  b.est.ref = wols(design.mat$X,datax$y,Vg = design.mat$Vg,b=b.res,w.mode='res',adj.v = TRUE)
  print(paste("rmse",round(rmse(rep(1,n_bulk)%*%t(b/sum(b)),(b.est.ref)),3)))
  print(round(b.est.ref,2))
  
  cat('---weight from residual and reference---',"\n")
  
  b.est.ref0 = wols(design.mat$X,datax$y,b=b.res,W=w,w.mode = 'res+ref_var')
  print(paste("rmse",round(rmse(rep(1,n_bulk)%*%t(b/sum(b)),(b.est.ref0)),3)))
  print(round(b.est.ref0,2))

  b.est.ref = wols(design.mat$X,datax$y,W=w,Vg = design.mat$Vg,b=b.res,w.mode = 'res+ref_var',adj.v = TRUE)
  print(paste("rmse",round(rmse(rep(1,n_bulk)%*%t(b/sum(b)),(b.est.ref)),3)))
  print(round(b.est.ref,2))
  
  cat('---weight from residual and reference bvb---',"\n")
  
  b.est.ref0 = wols(design.mat$X,datax$y,b=b.res,W=w,w.mode = 'res+bvb',Vg = design.mat$Vg)
  print(paste("rmse",round(rmse(rep(1,n_bulk)%*%t(b/sum(b)),(b.est.ref0)),3)))
  print(round(b.est.ref0,2))

  b.est.ref = wols(design.mat$X,datax$y,W=w,Vg = design.mat$Vg,b=b.res,w.mode = 'res+bvb',adj.v = TRUE)
  print(paste("rmse",round(rmse(rep(1,n_bulk)%*%t(b/sum(b)),(b.est.ref)),3)))
  print(round(b.est.ref,2))
...
## create bulk data(no technical noise) using Xin.
 ...
 $y = X\beta = U\beta + (X-U)\beta + r$. $y_g = u_g^T\beta+r_g$. $w_g = 1/r_g^2$. $y_g/r_g = x_g^T\beta/r_g+1$. So the fit is very good.
...
simu_func(design.mat.seger,datax.seger,b,rep(1/4,4))
...
simu_func(design.mat.baron,datax.baron,b,rep(1/4,4))
...
simu_func(design.mat.xin,datax.xin,b,rep(1/4,4))
...
simu_func(design.mat.seger,datax.seger,bulk.xin$b,rep(sum(bulk.xin$b)/4,4))

simu_func(design.mat.seger,datax.seger,bulk.xin$b,c(0.08, 0.28, 0.38, 0.27)*500)
...
simu_func(design.mat.baron,datax.baron,bulk.xin$b,rep(sum(bulk.xin$b)/4,4))


simu_func(design.mat.baron,datax.baron,bulk.xin$b,c(0.15,0.22,0.24,0.39)*500)
...
simu_func(design.mat.xin,datax.xin,bulk.seger$b,rep(sum(bulk.seger$b)/4,4))
...
simu_func(design.mat.baron,datax.baron,bulk.seger$b,rep(sum(bulk.seger$b)/4,4))
