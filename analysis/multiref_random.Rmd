---
title: "multiple reference, random select individuals"
author: "DongyueXie"
date: "2020-09-20"
...
## select 2 from each dataset as reference

another [version](multiref_random_nondiag.html).


```{r,results='asis'}
# select two from baron
baron_indi = levels(factor(baron$individual))
samples_baron_indi = c('1','4')
...
use all individuals from baron and muraro
