...
refs = set_data_multiref(list(baron=baron,muraro=muraro),bulk.obj$bulk,gene_length = NULL,protocols = c('UMI','UMI'),cell_types = cell_types)
```
...
m_bulk = ExpressionSet(assayData = counts(refs$bulk.obj))
#m_ref1 = sce_to_es(ref1)
music_out2 = music_prop(m_bulk,m_ref1,clusters = 'cell_type',samples = 'individual')
```
