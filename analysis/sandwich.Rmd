...
```{r}
knitr::kable(beta_hat_se,caption="compare mean of estiamted variance")
```
...
```{r}
knitr::kable(beta_hats_se_mse,caption="compare mean square error of log(estimated variance)")
```
