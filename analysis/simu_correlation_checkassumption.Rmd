---
title: "Check variance estimate and normality in simulation, when correlation presents"
author: "Dongyue Xie"
date: "2021-06-10"
...
```{r}
# set.seed(12345)
# simu = simu_corr_simple(ref,b.m,nreps=500,
#                         sigma2=sigma2,
#                         R=A,n_indi = 10,
#                         verbose = F,
#                         printevery = 1)
...
```{r}
# set.seed(12345)
# simu_trueb = simu_corr_simple(ref,b.m,nreps=500,
#                         sigma2=sigma2,
#                         R=A,n_indi = 10,
#                         verbose = F,
#                         printevery = 1,
