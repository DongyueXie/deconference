---
title: "Check variance estimate ,when correlation presents, xin data, add hc3"
author: "DongyueXie"
date: "2021-06-19"
...
[Previously](simu_correlation_checkassumption_real.html), when a gene is correlated with 500 other genes, the coverage after adjusting the correlation is low. Here we try the HC3 adjustment that adjusts the residuals.


1. already modified est_func.R

2. to do: modify simu_corr_simple to allow hc1, hc3
