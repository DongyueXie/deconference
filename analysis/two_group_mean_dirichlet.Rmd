  ...
  for(nb in nbs){
    for(aa in dirichlet.scale){
      for(alpha.cor in alpha.cors){
        ...
        simu_out = readRDS(file = paste('output/manuscript/simulation/simulation_',nb,'bulk_500genecor_',cor.status,'_',case,'_dirichlet',aa,'.rds',sep=''))
        ...
        print("coverage")
        print(colMeans(cover.naive0))
        print('standard error')
        print(round(colMeans(sd.naive0),3))
        ...
        print("coverage")
        print(colMeans(cover.naive))
        print('standard error')
        print(round(colMeans(sd.naive),3))
        ...
        print("coverage")
        print(colMeans(cover.naive.music))
        print('standard error')
        print(round(colMeans(sd.naive.music),3))
        ...
        print("coverage")
        print(round(colMeans(cover.asy.hc3,na.rm=TRUE),2))
        print('standard error')
        print(round(colMeans(simu_out$diff_hat_se_cor),3))
        ...
        print(round(colMeans(cover.asy.hc3,na.rm=TRUE),2))
        print('standard error')
        print(round(colMeans(simu_out$diff_hat_weight_se_cor),3))
        ...
        print("coverage")
        print(round(colMeans(cover.asy.cv,na.rm=TRUE),2))
        print("standard error")
        print(round(colMeans(simu_out$diff_hat_weight_se_cor_cv),3))
                
        print("rmse:")
        print(paste("our:",round(get_rmse_array(simu_out$p_hat_weight,simu_out$true_p),3)))
        print(paste("music:",round(get_rmse_array(simu_out$p_hat_music,simu_out$true_p),3)))
        
        print("coverage of p")
        print(mean(get_coverage_p(simu_out$p_hat_weight,simu_out$p_hat_weight_se_cor,simu_out$true_p)))
        print(mean(get_coverage_p(simu_out$p_hat_weight,simu_out$p_hat_weight_se_cor_cv,simu_out$true_p)))
...
```{r}
rowMeans(apply(simu_out$p_hat_weight,c(1,2),sd))
rowMeans(apply(simu_out$p_hat_weight_se_cor,c(1,2),mean))
rowMeans(apply(simu_out$p_hat_weight_se_cor_cv,c(1,2),mean))

boxplot(t(apply(simu_out$p_hat_weight_se_cor,c(1,2),mean)),ylim = c(0,0.5))
