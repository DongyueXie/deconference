...
cover.asy = temp<1.96
round(colMeans(cover.asy,na.rm=TRUE),2)

print('union of two sample t test and asymptotic')

cover.union = (cover.naive)|(cover.asy)
...
print('asymptotic')
temp = abs(simu_out$diff_hat_weight - rep(1,100)%*%t(dif))/simu_out$diff_hat_weight_se_cor
cover.asy = temp<1.96
colMeans(cover.asy)
