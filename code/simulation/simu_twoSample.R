...
simu_twosample = function(ref,b,
  ...
  for(reps in 1:nreps){
    ...
    se_unadj_hc0[reps,] = c(fit_unadj$sand.out$beta_se)
    diff_unadj[reps,] = c(fit_unadj$diff_group)
    diff_unadj_se_hc0[reps,] = c(fit_unadj$sand.out$diff_se)
    diff_unadj_p_hc0[reps,] = fit_unadj$sand.out$p_value
  ...
  # unadj
  ## sand
  ci_l = est_unadj - qnorm(1-alpha/2)*se_unadj_hc0
  ci_r = est_unadj + qnorm(1-alpha/2)*se_unadj_hc0
  ...
  ci_l = diff_unadj - qnorm(1-alpha/2)*diff_unadj_se_hc0
  ci_r = diff_unadj + qnorm(1-alpha/2)*diff_unadj_se_hc0
